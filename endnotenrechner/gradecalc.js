...
function validateModule(module, endnoteModule) {
  ...
  if ((module.ects < 4 || module.ects > 10) && module.ects != 14 && module.ects != 29 && module.ects != 30) {
    endnoteModule.classList.add("is-invalid");
    return false;
  }
...
function calcGrade() {
  ...
  for (let m in modules) {
    ...
    console.log("### modules: ", m, modules, mElem);
...
function getNewModuleElem(values) {
  ...
  endnoteModule_remove.className = "module-item module-item-del btn btn-secondary col";
...
function importieren() {
  ...
  input.onchange = function () {
    ...
    reader.onload = function () {
      ...
      initWithValues(data);
      calcGrade();
      endnoteImportInput.removeChild(input);
    };
